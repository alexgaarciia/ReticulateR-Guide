...
# Ensure the input shape is specified correctly as an integer tuple
input_shape <- as.integer(c(28, 28))
...
# Train the model
model$fit(train_images, train_labels, epochs = as.integer(5))
